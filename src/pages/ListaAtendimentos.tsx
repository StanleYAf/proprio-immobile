...
function normalize(a: AtendimentoRaw): Atendimento {
  return {
    ...
    status: pick(a, ['status', 'nomeStatus', 'situacao', 'nomeSituacao', 'descricaoStatus']),
    etapa: pick(a, ['etapa', 'nomeEtapa', 'descricaoEtapa', 'estagio', 'nomeEstagio', 'funil', 'nomeFunil', 'fase', 'nomeFase']),
